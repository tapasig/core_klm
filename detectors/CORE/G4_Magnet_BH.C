...
PHG4CylinderSubsystem *blackhole = new PHG4CylinderSubsystem("BH", 4);
//blackhole->set_double_param("radius", blackhole_radius);
blackhole->set_double_param("radius", G4MAGNET::magnet_outer_cryostat_wall_radius + 20);
blackhole->set_double_param("length", G4MAGNET::magnet_length);  // make it cover the world in length
...
blackhole->SuperDetector("BH");
// if (AbsorberActive) blackhole->SetActive();
