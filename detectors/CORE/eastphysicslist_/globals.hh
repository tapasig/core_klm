...
// 08.11.96 G.Cosmo - Added cbrt() definition and G4ApplicationState ype
...
//                    inclusion of CLHEP/config/TemplateFunctions.h for 1.3
// 15.12.99 G.Garcia - Included min, max definitions for NT with ISO rd
