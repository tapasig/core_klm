...
// Detector configuration options
  ...
  bool B0TRACKING = true; //Set to 'false' for nice PackMan views. Set 'true' for physics studies.
  bool B0ECAL = true; //Set to 'false' for nice PackMan views. Set 'true' for physics studies.
